...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$root\restaurant-service'; & $pythonCmd main.py" -WindowStyle Normal

Start-Sleep -Seconds 2

Write-Host "[2/6] Starting Menu Service on port 8002..." -ForegroundColor Yellow
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$root\menu-service'; & $pythonCmd main.py" -WindowStyle Normal

Start-Sleep -Seconds 2

Write-Host "[3/6] Starting Order Service on port 8003..." -ForegroundColor Yellow
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$root\order-service'; & $pythonCmd main.py" -WindowStyle Normal

Start-Sleep -Seconds 2

Write-Host "[4/6] Starting Delivery Service on port 8004..." -ForegroundColor Yellow
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$root\delivery-service'; & $pythonCmd main.py" -WindowStyle Normal

Start-Sleep -Seconds 2

Write-Host "[5/6] Starting Payment Service on port 8005..." -ForegroundColor Yellow
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$root\payment-service'; & $pythonCmd main.py" -WindowStyle Normal

Start-Sleep -Seconds 2

Write-Host "[6/6] Starting API Gateway on port 8000..." -ForegroundColor Yellow
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$root\gateway'; & $pythonCmd main.py" -WindowStyle Normal
